...
/// <summary>
    ...
    public class MeshHelper
    {
        ...
        //public static Mesh msh;
        static Mesh buildSplineMesh(Vector3[] vertices, int ignoreAxis, bool noTrisAtAll,Mesh msh =null)
        {
            // Tris
   ...
   */
    ...
    internal struct CurvyMeshSegmentInfo
    {
        ...
        public float Distance
        {
            get
            {
                return (mDistance == -1) ? Spline.TFToDistance(TF) : mDistance;
            }
        }
